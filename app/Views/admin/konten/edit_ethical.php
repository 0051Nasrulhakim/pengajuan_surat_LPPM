...
<?= $this->section('content'); ?>
    <div class="page">
        <?php 
                $errors 	= session()->getFlashdata('error_edit_ethical');
        ?>
        ...
        <div class="form">
            <div class="judul">
                Update Ethical clearance
            </div>
            <?php foreach($data as $d):?>
                <form action="<?= base_url()?>/Crud/update_ethicalClearance" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="nama_peneliti" id="nama_peneliti" rows="4" class="form-control"><?= $d['nama_peneliti']?></textarea>
                            <!-- <input type="text" class="form-control" name="nama_peneliti" value="<?= $d['nama_peneliti']?>"> -->
                        </div>
                    </div>
                    <div class="form-group row">
