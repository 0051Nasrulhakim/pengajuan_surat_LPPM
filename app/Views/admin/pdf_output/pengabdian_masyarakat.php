    ...
    <?php foreach($data['data'] as $d):?>
        <div class="page" style="margin-top: 4.5cm; margin-left: 2.5cm; margin-right: 1.4cm;">
            ...
            <div class="sambutan" style="margin-left: 2.2cm; margin-top: 0.4cm;">
                ...
                <p>Sehubungan dengan rencana pelaksanaan pengabdian masyarakat dosen <?= $d['fakultas']?> <?php if($d['prodi']!=""){echo "Prodi ".$d['prodi'];}?> <?= $d['universitas']?> berikut :</p>
            </div>
            <div class="isi" style="margin-left: 2.2cm;">
                <table style="border-collapse: collapse; text-align: center; margin-top: 0.2cm;" border="1px solid;">
                    <tr>
                        ...
                        <td style="width: 180px;">Nama Pelaksana Pengabdian</td>
                        <td style="width: 140px;">NIDN</td>
                        <td style="width: 200px;">Judul Penelitian</td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top;">1</td>
                        <td style="vertical-align: top; text-align: left"><p style="margin-left: 4px;">Dosen : <br><pre style="margin-bottom: 8px; margin-left: 4px;"><?= $d['nama_dosen']?></pre></p><p style="margin-left: 4px;">Mahasiswa:<br><pre style="margin-bottom: 10px; margin-left: 4px;"><?= $d['nama_mahasiswa']?></pre></p></td>
                        <td style="vertical-align: top; text-align: left"><p style="margin-left: 4px">NIDN: <br><pre style="margin-bottom: 8px; margin-left: 4px;"><?= $d['nidn']?></pre></p><p style="margin-left: 4px;">NIM:<br><?= $d['nim']?></pre></td>
                        <td style="vertical-align: top; text-align: left"><p style="margin-left: 4px;"><?= $d['judul_pengabdian']?></p></td>
                    </tr>
                </table>
            </div>
            <div class="kalimat-penutup" style="margin-left: 2.2cm; margin-top: 0.2cm;">
                <p>Maka bersama ini kami sampaikan permohonan izin untuk melaksanakan pengabdian masyarakat di instansi yang bapak/ibu pimpin.</p>
