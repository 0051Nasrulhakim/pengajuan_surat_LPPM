...
<body>
    ...
    <div class="page" style="margin-top: 4.5cm; margin-bottom: 2.5cm; margin-left: 2.5cm; margin-right: 1.7cm;">
        ...
        <div class="isi-surat">
            ...
            <table style="margin-left: 0.5cm; margin-bottom: 0.2cm;">
                ...
                <tr>
                    <td>4. Jabatan </td>
                    <td>:</td>
                    <td><?= $d['jabatan_bertandatangan']?></td>
                </tr>
                <tr>
            ...
            <table style="margin-bottom: 0.2cm;">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><?= tglIndonesia($d['tanggal_permohonan']);?></td>
                </tr>
                <tr>
                    <td>Tahun Terbit </td>
                    <td>:</td>
