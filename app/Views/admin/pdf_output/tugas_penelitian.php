        ...
        <div class="page" style="margin-top: 4.5cm; margin-left: 2.5cm; margin-right: 1.7cm;">
            ...
            <div class="isi-surat" >
                ...
                <table style="margin-left: 0.5cm; margin-bottom: 0.2cm; ">
                    <tr>
                        <td style="width: 225px; ">1. Nama </td>
                        <td>:</td>
                        <td style="width: 377px;"><?= $d['nama_yang_bertanda_tangan']?></td>
                    </tr>
                    <tr>
                        <td>2. Jabatan </td>
                        <td>:</td>
                    ...
                    <tr style="vertical-align: top;">
                        <td>3. Alamat </td>
                        <td>:</td>
                        <td style="width: 377px;"><?= $d['alamat']?></td>
                    </tr>
                </table>
                <p style="margin-bottom: 0.2cm;">Memberikan Tugas Kepada :</p>
                <table style="margin-left: 0.5cm; margin-bottom: 0.2cm; margin-right: 1.7cm;">
                    <tr style="vertical-align: top;">
                        <td style="width: 225px;">1. Nama Dosen </td>
                        <td>:</td>
                        <td style="width: 377px;"><pre><?= $d['nama_dosen']?></pre></td>
                    </tr>
                    <tr>
                        <td>2. Jabatan </td>
                        <td>:</td>
                    ...
                    <tr style="vertical-align: top;">
                        ...
                        <td>:</td>
                        <td style="width: 377px;"><pre><?= $d['nama_mahasiswa']?></pre></td>
                    </tr>
                    <tr style="vertical-align: top;">
                        <td>4. Keperluan </td>
                        <td>:</td>
                        <td style="width: 377px;"><?= $d['keperluan'] .' dengan judul '. $d['judul_penelitian']?></td>
                    </tr>
                    <tr>
                    ...
                    <tr style="vertical-align: top;">
                        <td>5. Tujuan </td>
                        <td>:</td>
                        <td style="width: 377px;"><?= $d['tujuan'] ?></td>
                    </tr>
                </table>
