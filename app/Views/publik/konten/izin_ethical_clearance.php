...
<?= $this->section('content'); ?>
    <?php 
        $errors 	= session()->getFlashdata('error_izin_ethical_clearance');
        $success    = session()->getFlashdata('sukses_izin_ethical_clearance');
        $limit    = session()->getFlashdata('Limit_pengajuan');
    ?>
    <div class="page">
        <div class="form">
            <div class="judul">
                Form Surat Tugas Izin Ethical Clearance
            </div>
            <?php
                if(!empty($errors)){
            ?>
            ...
            <form action="<?= base_url()?>/crud/insert_izin_ethical_clearance" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="lampiran" value="-" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="hal" class="col-sm-2 col-form-label">Perihal</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="perihal" value="Permohonan Ethical Clearance" readonly>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="nama_peneliti" id="nama_peneliti" rows="4" class="form-control"></textarea>
