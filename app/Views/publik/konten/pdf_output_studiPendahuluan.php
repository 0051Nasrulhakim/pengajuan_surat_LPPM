...
<div class="container-surat" style=" margin-top: 4cm;">
    ...
    <div class="kepada" style="margin-left: 2.4cm; margin-top: 1cm;">
        ...
        <div class="isi" style="margin-top: 10px; text-align: justify;">
            ...
            <br> Dengan hormat,  Sehubungan dengan surat tugas akhir skripsi mahasiswa <?php if($d['prodi_mhs'] != null){echo "Prodi";}?> <?= $d['prodi_mhs']?> <?php if($d['fakultas_mhs'] != null){echo "Fakultas";}?> <?= $d['fakultas_mhs']?> <?=$d['universitas']?> Tahun akademik <?=$d['tahun_akademik']?>, Perkenalkanlah mahasiswa kami untuk melakukan 
            ...
            <table style="margin-top: 5px;">
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; padding: 5px; border: 1px solid; text-align: left;"><?= $d['nama']. ' ' . $d['nim']. ' ' .$d['alamat_mhs']?> </td>
