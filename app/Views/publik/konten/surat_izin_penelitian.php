...
<?= $this->section('content'); ?>
    <?php 
        $errors 	= session()->getFlashdata('errror_izin_penelitian');
        $success    = session()->getFlashdata('sukses_izin_penelitian');
    ...
    <div class="page">
        <div class="form">
            ...
            <form action="<?= base_url()?>/crud/surat_izin_penelitian" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="perihal" value="Permohonan Izin Penelitian" readonly>
                    </div>
                </div>
                <div class="form-group row">
