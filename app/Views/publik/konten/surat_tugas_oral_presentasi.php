...
<?= $this->section('content'); ?>
    <?php 
        $errors 	= session()->getFlashdata('error_surat_oral_presentasi');
        $success    = session()->getFlashdata('sukses_surat_oral_presentasi');
        $limit      = session()->getFlashdata('Limit_pengajuan');
    ?>
     <div class="page">
        <div class="form">
            <div class="judul">
                Form Surat Tugas Oral Presentasi
            </div>
            <?php
                if(!empty($errors)){
            ?>
            ...
            <form action="<?=base_url()?>/crud/insert_oral_presentasi" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="bentuk_kegiatan" value="Oral Presentasi" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="hal" class="col-sm-2 col-form-label">Nama Kegiatan</label>
                    <div class="col-sm-10">
                        <textarea name="nama_kegiatan" id="nama_kegiatan" rows="4" class="form-control"></textarea>
