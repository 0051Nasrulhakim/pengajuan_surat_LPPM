...
<?= $this->section('content'); ?>
    <?php 
        $errors 	= session()->getFlashdata('error_surat_tugas_publikasi');
        $success    = session()->getFlashdata('sukses_surat_tugas_publikasi');
    ...
    <div class="page">
        <div class="form">
            ...
            <form action="<?=base_url()?>/crud/insert_surat_tugas_publikasi" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="bentuk_tugas" value="Publikasi Artikel" readonly>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nomor_dan_volume">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="penerbit" id="penerbit" rows="4" class="form-control"></textarea>
