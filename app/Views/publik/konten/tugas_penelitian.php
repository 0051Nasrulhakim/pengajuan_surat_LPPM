...
<?= $this->section('content'); ?>
    <?php 
        $errors 	= session()->getFlashdata('error_tugas_penelitian');
        $success    = session()->getFlashdata('sukses_tugas_penelitian');
        $limit      = session()->getFlashdata('Limit_pengajuan');
    ?>
    <div class="page">
        <div class="judul">
            Form Surat Tugas Penelitian
        </div>
        <div class="form">
            <?php
                if(!empty($errors)){
            ...
            ?>
            <form action="<?= base_url()?>/Crud/insert_tugasPenelitian" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <!-- <input type="text" class="form-control" name="jabatan_yang_bertanda_tangan" value="Penata Muda/III.c"> -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="keperluan" value="Melaksanakan penelitian" readonly>
                    </div>
                </div>
                <div class="form-group row">
