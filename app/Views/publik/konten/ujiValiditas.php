...
<div class="page">
    <?php 
        $inputs 	= session()->getFlashdata('inputs_ujiValiditas');
        $errors 	= session()->getFlashdata('errors_ujiValiditas');
        $success    = session()->getFlashdata('success_ujiValiditas');
    ...
    <div class="form">
        ...
        <form action="<?= base_url()?>/Crud/insert_ujiValiditas" enctype="multipart/form-data" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="hal" value="Uji Validitas" readonly>
                </div>
            </div>
            <div class="form-group row">
