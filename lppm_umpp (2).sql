...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2023 at 03:59 PM
...
--
-- Dumping data for table `limit_pengajuan`
--

INSERT INTO `limit_pengajuan` (`id`, `nama`, `nim_atau_nidn`, `tanggal_pengajuan`, `perihal`) VALUES
(9, 'nasrul hakim', '19.240.0051', '2022-06-30', 'Permohonan Izin Studi Pendahuluan');
...
INSERT INTO `log_login` (`id`, `username`, `login_at`, `logout_at`, `ip`, `browser`) VALUES
(57, 'admin123', '2022-06-29 23:12:36', '', '::1', 'Edge'),
(58, 'admin123', '2022-06-30 11:16:46', '', '::1', 'Edge');
...
--
-- Dumping data for table `studi_pendahuluan`
--

INSERT INTO `studi_pendahuluan` (`id`, `nama_yang_bertanda_tangan`, `nik_yang_bertanda_tangan`, `nomor_surat`, `lampiran`, `hal`, `tanggal_surat`, `ditujukan_kepada`, `prodi_mhs`, `fakultas_mhs`, `universitas`, `tahun_akademik`, `nama`, `nim`, `alamat_mhs`, `dosen_pembimbing`, `judul_penelitian`, `status`, `nomor_telfon`, `status_pengajuan`) VALUES
(155, 'Nuniek Nizmah F,M.Kep., Sp.KMB', '1970090819931007', '', '-', 'Permohonan Izin Studi Pendahuluan', '2022-06-30', 'stmik widya pratama pekalongan', 'Diploma Tiga Manajement Informatika', 'Fakultas Ilmu Kesehatan', 'Universitas Muhammadiyah Pekajangan Pekalongan', '2021/2022', 'nasrul hakim', '19.240.0051', 'wonoyoso gg 5', 'eko budi', 'tes', '1', '081227643944', 'Dalam Proses'),
(156, 'Nuniek Nizmah F,M.Kep., Sp.KMB', '1970090819931007', '', '-', 'Permohonan Izin Studi Pendahuluan', '2022-06-30', 'stmik widya pratama pekalongan', 'Diploma Tiga Manajement Informatika', 'Fakultas Ilmu Kesehatan', 'Universitas Muhammadiyah Pekajangan Pekalongan', '2021/2022', 'nasrul hakim', '19.240.0051', 'wonoyoso gg 5', 'eko budi', 'tes', '1', '081227643944', 'Dalam Proses'),
(157, 'Nuniek Nizmah F,M.Kep., Sp.KMB', '1970090819931007', '', '-', 'Permohonan Izin Studi Pendahuluan', '2022-06-30', 'stmik widya pratama pekalongan', 'Diploma Tiga Manajement Informatika', 'Fakultas Ilmu Kesehatan', 'Universitas Muhammadiyah Pekajangan Pekalongan', '2021/2022', 'nasrul hakim', '19.240.0051', 'wonoyoso gg 5', 'eko budi', 'tes', '1', '081227643944', 'Dalam Proses');
